...
name: rework-commits
description: >-
  Rework a branch into a sequence of small, semantic commits for review. Use
  when asked to split a branch, restructure messy commits, or break a large
  diff into reviewable, logically-ordered commits before opening a PR.
